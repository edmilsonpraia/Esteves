      ...
      <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="space-y-3">
            ...
            <button 
              type="button"
              className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors font-medium flex items-center justify-center gap-3"
            >
          ...
          {isLogin && (
            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
              <h3 className="text-sm font-semibold text-blue-900 mb-3">🎯 {t('login.demoAccounts.title')}:</h3>
              <div className="space-y-2">
                <button
                  onClick={() => fillDemoCredentials('admin')}
                  className="w-full text-left text-xs text-blue-700 hover:text-blue-900 p-2 bg-white rounded border hover:border-blue-300 transition-colors"
                >
                  <strong>{t('login.demoAccounts.admin')}:</strong> admin@gmail.com | 123456
                </button>
                <button
                  onClick={() => fillDemoCredentials('user')}
                  className="w-full text-left text-xs text-blue-700 hover:text-blue-900 p-2 bg-white rounded border hover:border-blue-300 transition-colors"
                >
                  <strong>{t('login.demoAccounts.user')}:</strong> user@gmail.com | 123456
                </button>
              </div>
            </div>
          )}
